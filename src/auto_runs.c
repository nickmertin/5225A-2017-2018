...
skip3:
	...
	moveToTargetSimpleAsync(106.5, 109.5, gPosition.y, gPosition.x, -127, 1, 0, 0, 0, stopSoft, false);
	driveTimeout = nPgmTime + 2000;
...
skip5:
	...
	moveToTargetSimpleAsync(112, 136, gPosition.y, gPosition.x, 127, 1, 10, 30, 13, stopNone, true);
	driveTimeout = nPgmTime + 2000;
...
skip6:
	...
	// 14
	moveToTargetSimpleAsync(6, 28, gPosition.y, gPosition.x, 127, 1, 8, 30, 13, stopNone, true);
	driveTimeout = nPgmTime + 2000;
...
skip7:
	...
	driveTimeout = nPgmTime + 2000;
	timeoutWhileLessThanF(VEL_LOCAL_Y, 0.5, &gPosition.x, 71, driveTimeout, TID2(skills, 15, 3));
	liftRaiseSimpleAsync(LIFT_MOBILE_THRESHOLD, 127, 0);
