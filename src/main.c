...
#pragma config(Motor,  port3,           driveL1,       tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port4,           driveL2,       tmotorVex393TurboSpeed_MC29, openLoop)
#pragma config(Motor,  port5,           liftL2,        tmotorVex393TurboSpeed_MC29, openLoop)
#pragma config(Motor,  port6,           mobile,        tmotorVex393TurboSpeed_MC29, openLoop, reversed)
...
#pragma config(Motor,  port9,           liftR,         tmotorVex269_MC29, openLoop, reversed)
