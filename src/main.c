...
#pragma config(Motor,  port3,           driveL1,       tmotorVex393TurboSpeed_MC29, openLoop)
#pragma config(Motor,  port4,           driveL2,       tmotorVex393TurboSpeed_MC29, openLoop, reversed)
#pragma config(Motor,  port5,           driveL3,       tmotorVex393TurboSpeed_MC29, openLoop)
...
#pragma config(Motor,  port8,           driveR3,       tmotorVex393TurboSpeed_MC29, openLoop, reversed)
