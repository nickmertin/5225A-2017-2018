...
/* Functions */
void moveToTargetSimple(float y, float x, float ys, float xs, byte power, byte startPower, float maxErrX, float decelEarly, byte decelPower, float dropEarly = 0, tStopType stopType = stopSoft | stopHarsh, bool slow = true);
void moveToTargetDisSimple(float a, float d, float ys, float xs, byte power, byte startPower, float maxErrX, float decelEarly, byte decelPower, float dropEarly = 0, tStopType stopType = stopSoft | stopHarsh, bool slow = true);
...
12, (moveToTargetSimple, float, float, float, float, byte, byte, float, float, byte, float, tStopType, bool), ;,
12, (moveToTargetDisSimple, float, float, float, float, byte, byte, float, float, byte, float, tStopType, bool), ;,
