...
void timeoutWhileLessThanL(tSensors sen, float vel, long threshold, unsigned long timeout, const unsigned char *routine, unsigned short id, bool kill = true);
void timeoutWhileGreaterThanL(tSensors sen, float vel, long threshold, unsigned long timeout, const unsigned char *routine, unsigned short id, bool kill = true);
